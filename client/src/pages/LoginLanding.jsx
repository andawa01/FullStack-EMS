  ...
  const portalOptions = [
    {
      ...
      title: "Admin Portal",
      description:
        "Manage employees, departments, payroll and system configurations securely.",
      icon: ShieldIcon,
    },
    {
      to: "/login/employee",
      ...
      description:
        "View your profile, track attendance, request time off, and access payslips securely.",
      icon: UserIcon,
    },
  ];
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen">
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div className="mt-12 text-center md:text-left text-sm text-slate-400">
            <p>© {new Date().getFullYear()} Evans. All rights reserved.</p>
          </div>
        </div>
      </div>
    </div>
