import { AppleIcon, Loader2Icon, LogInIcon, LogOutIcon } from "lucide-react";
  ...
  return (
    <div className="absolute bottom-4 right-4 flex flex-col z-1">
      <button
        ...
        disabled={loading}
        className={`w-full max-w-xs flex justify-between items-center gap-8 p-4 rounded-xl bg-linear-to-br text-white ${isCheckIn ? "from-stone-700 to-slate-900" : "from-indigo-600 to-indigo-700"}`}
      >
        {loading ? (
        ...
        <div className="relative flex flex-col items-center text-center">
          <h2 className="text-lg font-medium mb-1">
            {loading ? "Processing..." : isCheckIn ? "Clock Out" : "Clock In"}
          </h2>
